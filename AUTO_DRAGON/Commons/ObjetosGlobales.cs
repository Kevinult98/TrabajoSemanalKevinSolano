...
namespace AUTO_DRAGON.Commons
{
    public static class ObjetosGlobales

        //formularios de uso recurrente en el sistema
        //si el formulario debería verse SOLO UNA VEZ por sesión lo más 
        //conveniente es definirlo de forma estática, y no dinámica.
    {
        ...
        //se definen los obetos basados en clases que deben ser accesibles desde cualquier lugar de la app

        public static Logica.Models.Usuario MiUsuarioDeSistema = new Logica.Models.Usuario();

        public static Formularios.FrmUsuarioRecuperarContra FormularioRecuperacionContrasennia = new Formularios.FrmUsuarioRecuperarContra();
